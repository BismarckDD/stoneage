...
void old_lssproto_W_send(int fd, int x, int y, char *direction) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(x),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(direction),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
}
...
void old_lssproto_EV_send(int fd, int event, int seqno, int x, int y, int dir) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(event),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(seqno),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(x),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(dir),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
261 :   <LI><a name="CS_EN"><font color=red>clienttoserver EN( int x, int y
);<br></font></a> 262 :     ?????????叉?????????????????????? 263 :
??卷??????????????????????????? 264 :       <br><br> 265 :       <dl> 266
:     <dt>int x,y 267 :     <dd>??????????????????????火? 268 :       </dl> 269
:       <br> 270 :       <br> 271 :       <hr> 272 :       <br>
*/
...
/*
273 :   <LI><a name="CS_DU"><font color=red>clienttoserver DU( int x, int
y);<br></font></a> 274 :     ????????????可?????????????????? 275 :
??卷??????????????????????????? 276 :       <br><br> 277 :       <dl> 278
:     <dt>int x,y 279 :     <dd>??????????????????????火? 280 :       </dl> 281
:       <br> 282 :       <br> 283 :       <hr> 284 :       <br>
*/
...
/*
298 :   <LI><a name="CS_EO"><font color=red>clienttoserver EO( int dummy
);<br></font></a> 299 :     ????????????????????????? 300 :       <dl> 301 :
<dt>int dummy 302 :     <dd>??????????????? 303 :       </dL> 304 :       <br>
305 :       <br>
306 :       <hr>
307 :       <br>
308 :
...
void old_lssproto_EO_send(int fd, int dummy) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(dummy),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
309 :   <LI><a name="CS_BU"><font color=red>clienttoserver BU( int dummy
);<br></font></a> 310 :     ???????????????κ???????? 311 :       <dl> 312 :
<dt>int dummy 313 :     <dd>??????????????? 314 :       </dL> 315 :       <br>
316 :       <br>
317 :       <hr>
318 :       <br>
319 :
...
/*
320 :   <LI><a name="CS_JB"><font color=red>clienttoserver JB( int x, int y
);<br></font></a> 321 :     兝?·卯?·???????????? EN ???刺?? 322
:       <dl> 323 :     <dt>int x, int y; 324 :     <dd>???????????火? 325 :
</dL> 326 :       <br> 327 :       <br> 328 :       <hr> 329 :       <br> 330 :
*/
...
/*
331 :   <LI><a name="CS_LB"><font color=red>clienttoserver LB( int x, int y
);<br></font></a> 332 :     兝?·卯??·???????????? EN ???刺?? 333 :
<dl> 334 :     <dt>int x, int y; 335 :     <dd>???????????火? 336 :       </dL>
337 :       <br>
338 :       <br>
339 :       <hr>
340 :       <br>
...
/*
354 :   <LI><a name="CS_B"><font color=red>clienttoserver B( string command
);<br></font></a> 355 :
??????????????·卯??????叉???????吻????????叉????????????￥???「▍?叉??????￥???「▍??????????「▍???<br><br>
356 : <ul>
...
void old_lssproto_B_send(int fd, char *command) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(command),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
542 :   <LI><a name="SKD"><font color=red>clienttoserver SKD( int dir , int
index );<br></font></a> 543 :       (SKillDir) 544 :       叉?????????????
545 :       <br><br>
546 :       <dl>
547 :     <dt>int dir
548 :     <dd>???????
...
void old_lssproto_SKD_send(int fd, int dir, int index) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(dir),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(index),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
633 :   <li><a name="CS_ID"><font color=red>clienttoserver ID( int x, int y, int
haveitemindex,int toindex);<br></font></a> 634 :
(useItemDir)??????????????????????????????????????????? 635 :
???????????? 636 : 637 : 638 :       <dl> 639 :     <dt>int x,y 640 :     <dd>
希?x,y ?火 641 :     <dt>int haveitemindex 642 :     <dd>
????????????????????? 643 :     <dt>int toindex 644 :     <dd>
Κ?????????????????????????index???????????????? 645 :     <pre> 646 : 希
= 0 647 :       ???  = 1 ?5 648 :       ??    = 6 ?10 ?S N
?0?4?▋??希???????? 649 :     </pre> 650 :
▋?「????希??????????-1?????<br> 651 :     <br> 652 :       </dl>
653 :       <br>
654 :       <br>
655 :       <hr>
656 :       <br>
...
void old_lssproto_ID_send(int fd, int x, int y, int haveitemindex,
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(haveitemindex),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(toindex),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
662 :   <LI><a name="PI"><font color=red>clienttoserver PI( int x, int y,int dir
);<br></font></a> 663 :       (PickupItem) 664 :
??????????℉????????9??????<br><br> 665 :       <dl> 666 :     <dt>int
x,y 667 :     <dd> 希?x,y ?火 668 :     <dt>int dir 669 :
<dd>??????????℉????? ????℉?????? 670 :       </dl> 671 :       <br> 672 :
<hr> 673 :       <br> 674 : 675 :
*/
...
void old_lssproto_DI_send(int fd, int x, int y, int itemindex) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(itemindex),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
...
void old_lssproto_DG_send(int fd, int x, int y, int amount) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(amount),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
...
void old_lssproto_DP_send(int fd, int x, int y, int petindex) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(petindex),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
...
void old_lssproto_MI_send(int fd, int fromindex, int toindex) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(fromindex),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(toindex),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
...
void old_lssproto_MSG_send(int fd, int index, char *message, int color) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(index),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(message),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(color),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
830 :   <LI><a name="CS_PMSG"><font color=red>clienttoserver PMSG( int index,
int petindex, int itemindex, string  message , int color );<br></font></a> 831 :
(PetMeSsaGe) 832 :       ??????????????????????index?希??????? 833 :
?????????????????????????<br><br> 834 :       <dl> 835 :     <dt>int index
836 :     <dd>??????????????????
837 :     <dt>int petindex
838 :     <dd>?吻??????????
...
/*
921 :   <LI><a name="DAB"><font color=red>clienttoserver DAB( int index
);</font></a><br> 922 :       (DeleteAddressBookitem)???????????????????? 923 :
?????????????????阪???????????AB?? 924 : ??????????????牙???????????????
925 :       ????╱?????
926 :       <dl>
927 :     <dt>int index
...
/*
935 :   <LI><a name="AAB"><font color=red>clienttoserver AAB( int x, int y
);</font></a><br> 936 :       (AddAddressBookitem) 937 :
??〈?????????????????????? 938 :       ???????????????阪?????? 939 :
?????AB???????????????牙????? 940 :       <dl> 941 :         <dt>int
x,y 942 :         <dd>希?????火 943 :       </dl> 944 :       <br> 945 :
<hr> 946 :       <br> 947 :
*/
...
/*
948 :   <LI><a name="L"><font color=red>clienttoserver L( int
dir);</font></a><br> 949 :       (Look) 950 :       dir
????????????????????????????伶 951 : ???????????????﹐????????????????
952 :       ???????????????????????????????
953 :       ????????????????????????????即????
954 :       ??〈?????(仟??NPC?????)??????〈???NPC?▋
...
/*
962 :   <LI><a name="C2STK"><font color=red>clienttoserver TK( int x, int y,
string message ,int color, int area);<br></font></a> 963 :       (TalK) 964 :
???????????????刺?????<br><br> 965 :       <dl> 966 :         <dt>int x,y
967 :         <dd>希?????火
...
void old_lssproto_TK_send(int fd, int x, int y, char *message, int color,
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(color),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(area),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1071 :   <LI><a name="CS_M"><font color=red>clienttoserver M(int fl , int x1 ,
int y1 , int x2, int y2 );<br></font></a> 1072 :
????????????????刺??M???????????? 1073 :       ????????MC???????????????????
1074 :       卷??????????????希????????????
1075 :       <dl>
1076 :     <dt>int fl
...
void old_lssproto_M_send(int fd, int fl, int x1, int y1, int x2, int y2) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(fl),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(x1),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y1),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(x2),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y2),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1128 :   <LI><a name="C2SC"><font color=red>clienttoserver C( int index
);<bR></font></a> 1129 :       ???????????????index CA ????????刺?? 1130 :
C ?刺??????????????????刺????? 1131 :       <br> 1132 :       <hr> 1133 : <br>
1134 :
*/
...
/*
1345 :   <LI><a name="CS_S"><font color=red>clienttoserver S( string category
);<br></font></a> 1346 :       (Status) 1347 :       ??????????????? 1348 : <dl>
...
void old_lssproto_S_send(int fd, char *category) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(category),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1745 :   <li><a name="CS_FS"><font color=red>clienttoserver FS( int
flg);<br></font></a> 1746 :
(FlgSet)????向????DUEL???????????????????????On/Off???<br><br> 1747 :
1748 :       <dl>
1749 :         <dt>int flg
1750 :         <dd> 0 bit  0: ??Off                  1: ??On<br>
1751 :              ?????1 bit  0: ·卯代??off          1: ·卯代??On
<br> 1752 :              2 bit  0: DUEL off                 1: DUEL On<br> 1753
:              3 bit  0: ?二????????     1: ???????????????????<br> 1754 : 4 bit
0: ???OK               1: ????呀<br> 1755 :       </dl> 1756 :       <br>
1757 :       <br>
1758 :       <hr>
1759 :       <br>
*/
...
void old_lssproto_FS_send(int fd, int flg) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(flg),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1774 :   <li><a name="CS_HL"><font color=red>clienttoserver HL( int
flg);<br></font></a> 1775 :
(HeLp)???????　叉??????ON?????兝??·卯?????????<br><br> 1776 : 1777
:       <dl> 1778 :         <dt>int flg 1779 :         <dd> 0: ??????Off 1:
??????On<br> 1780 :       </dl> 1781 :       <br> 1782 :       <br> 1783 : <hr>
1784 :       <br>
*/
...
/*
1795 :   <li><a name="CS_PR"><font color=red>clienttoserver PR( int x, int y,int
request);<br></font></a> 1796 :       (PartyRequest)???向?or?? ??????<br><br>
1797 :
1798 :       <dl>
1799 :     <dt>int x,y
1800 :     <dd> 希?x,y ?火
...
void old_lssproto_PR_send(int fd, int x, int y, int request) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(request),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1824 :   <li><a name="CS_KS"><font color=red>clienttoserver KS( int
petarray);<br></font></a> 1825 :       (Kyoryu
Select)·卯??????︻????<br><br> 1826 : 1827 :       <dl> 1828 :     <dt>int
petarray 1829 :     <dd>0 ? 4
??????︻??????????????????????·卯??????????????????-1?向??? 1830 :
</dl> 1831 :       <br> 1832 :       <br> 1833 :       <hr> 1834 :       <br>
*/

void old_lssproto_KS_send(int fd, int petarray) {
  lssproto_CreateHeader(lssproto.work, "KS");
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(petarray),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1852 :   <li><a name="CS_AC"><font color=red>clienttoserver AC( int x, int y,
int actionno);<br></font></a> 1853 :       (action)?凹?????牙????<br><br> 1854 :
1855 :       <dl>
1856 :     <dt>int x,y
1857 :     <dd> 希?x,y ?火
...
void old_lssproto_AC_send(int fd, int x, int y, int actionno) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(actionno),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1883 :   <li><a name="CS_MU"><font color=red>clienttoserver MU( int x, int y,
int array, int toindex);<br></font></a> 1884 :       (magic
use)??????????????????????????????????????? 1885 :       ????????????
1886 :
1887 :
1888 :       <dl>
...
void old_lssproto_MU_send(int fd, int x, int y, int array, int toindex) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(y),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(array),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(toindex),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
...
/*
1907 :   <li><a name="CS_PS"><font color=red>clienttoserver PS( int
havepetindex, int havepetskill, int toindex, string data);<br></font></a> 1908 :
(PetSkill use )??????????????????????? 1909 : 1910 :       <dl> 1911 :
<dt>int havepetindex 1912 :         <dd>?吻??????????? 1913 : <dt>int
havepetskill 1914 :         <dd>?吻????????? 1915 :     <dt>int toindex 1916
:     <dd> Κ???????????????????????index???????????????? 1917 :     <pre>
1918 :       希    = 0
1919 :       ???  = 1 ?5
1920 :       ??    = 6 ?10 ?S N ?0?4?▋??希????????
...
1924 :           <dt>string data
1925 :
<dd>至??????????????haveitemindex1|haveitemindex2|haveitemindex3|...<br>
1926 :               ??????????吻??向?????
1927 :
1928 :       </dl>
1929 :
...
void old_lssproto_PS_send(int fd, int havepetindex, int havepetskill,
                          int toindex, char *data) {
  lssproto_CreateHeader(lssproto.work, "PS");
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(havepetindex),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(havepetskill),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(toindex),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(data),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1963 :   <LI><a name="ST"><font color=red>clienttoserver ST( int titleindex
);<br></font></a> 1964 :       (SelectTitle) 1965 :       ??????titleindex ?
-1 ??????????????? 1966 :       ??<br><br> 1967 :       <dl> 1968 : <dt>int
titleindex 1969 :     <dd>?吻????? 1970 :       </dl> 1971 :
????Txt?????????????????????????? 1972 :       ?二ρ???? 1973 :       <br> 1974 :
<br> 1975 :       <hr> 1976 :       <br> 1977 : 1978 :
*/

void old_lssproto_ST_send(int fd, int titleindex) {
  lssproto_CreateHeader(lssproto.work, "ST");
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(titleindex),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
1979 :   <LI><a name="DT"><font color=red>clienttoserver DT( int titleindex
);<br></font></a> 1980 :       (DeleteTitle) 1981 :       ???????<br><br>
1982 :       <dl>
...
/*
1993 :   <LI><a name="FT"><font color=red>clienttoserver FT( string data
);<br></font></a> 1994 :       (inputFreeTitle) 1995 :
希?向?????向????<br><br> 1996 :       <dl> 1997 :     <dt>string data
1998 :     <dd>希?向?????EUC????????????????
1999 :         ???????????????????1?info?牙??
2000 :         ?????????更????????????????
2001 :         ???????╱?????
...
/*
2019 :   <LI><a name="C2SSKUP"><font color=red>clienttoserver SKUP( int skillid
);<br></font></a> 2020 :       (SKillUP) 2021 :       ??????????????<br><br>
2022 :       <dl>
2023 :     <dt>int skillid
2024 :     <dd>???????????0=▍?, 1=??, 2=舌?, 3=???
2025 :       </dl>
...
void old_lssproto_SKUP_send(int fd, int skillid) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(skillid),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
2030 :   <LI><a name="CS_KN"><font color=red>clienttoserver KN( int
havepetindex, string data );<br></font></a> 2031 :       (inputKyoryuName) 2032
:       ?????〈?向????<br><br> 2033 :       <dl> 2034 :     <dt>int havepetindex
2035 :     <dd>????吻??
2036 :     <dt>string data
2037 :     <dd>希????????????〈?????
2038 :
...
/*
2166 :   <LI><a name="CS_WN"><font color=red>clienttoserver WN( int x, int y,
int seqno, int objindex, int select, string data );<br></font></a> 2167 : <br>
2168 :       ?????牙?▋??刺?<br>
2169 :       <br>
2170 :       <dl>
2171 :         <dt>int x,y
...
2176 :         <dd>????????objindex?????刺?
2177 :         <dt>int select
2178 :         <dd>??????︻?????????︻??????????WN ?buttontype
?define?可???刺?? 2179 :         <dt>string data 2180 :
<dd>??向?????????????向??????? 2181 : ︻????????????︻???吻???1??? 2182 :
?????????︻???????????????????????????? 2183 :             <br><br>??????<br>
2184 :                 ????ㄩ︻???吻??????????<br>
2185 :                 ????ㄩ︻?????????吻??????|??<br>
2186 :               ??兝    ㄩ??ㄩ1  ??ㄩ2  ?ㄩ3
...
void old_lssproto_WN_send(int fd, int x, int y, int seqno, int objindex,
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(seqno),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(objindex),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(select),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(data),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
...
/*
2238 :   <LI><a name="CS_SP"><font color=red>clienttoserver SP( int x, int y,
int dir );<br></font></a> 2239 :       (SetPosition)<br> 2240 :
???????希???????? 2241 :           ?????????????火?????<br> 2242 :
<br> 2243 :       <dl> 2244 :         <dt>int x,y, dir 2245 : <dd>?火,??? 2246 :
</dl> 2247 :       <br> 2248 :       <br> 2249 :       <hr> 2250 :       <br>
2251 :       <!-- ???????????????????   -->
2252 :
*/
...
/*
2253 :   <LI><a name="CS_CLIENTLOGIN"><font color=red>clienttoserver
ClientLogin(string cdkey,string passwd);<br></font></a> 2254 :
??????????????????????????????? 2255 : ???????????????????????????????
2256 :       ???????????????????????????????
2257 :       ???Μ???????????????????????????
2258 :       岌????????????阪??????冉?????????
...
void old_lssproto_ClientLogin_send(int fd, char *cdkey, char *passwd) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(cdkey),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(passwd),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
  //    TNJ;
}
/*
2284 :   <LI><a name="CS_CREATENEWCHAR"><font color=red>clienttoserver
CreateNewChar(int dataplacenum, string charname,int imgno , int faceimgno, int
vital, int str, int tgh, int dex, int earth, int water, int fire, int wind, int
hometown);<br></font></a> 2285 :       ???????????? 2286 :       <br><br>
2287 :       <dl>
...
void old_lssproto_CreateNewChar_send(int fd, int dataplacenum, char *charname,
                                     int imgno, int faceimgno, int vital,
                                     int str, int tgh, int dex, int earth,
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(dataplacenum),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(charname),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(imgno),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(faceimgno),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(vital),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(str),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(tgh),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(dex),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(earth),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(water),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(fire),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(wind),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(hometown),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
}
/*
2338 :   <LI><a name="CS_CHARDELETE"><font color=red>clienttoserver
CharDelete(string charname);<br></font></a> 2339 :       ?????? 2340 :
<br><br> 2341 :       <dl> 2342 :     <dt>string charname 2343 :
<dd>?????????????????????????? 2344 :       </dl> 2345 :       <br> 2346 : <br>
2347 :       <hr>
2348 :       <br>
*/
...
/*
2366 :   <LI><a name="CS_CHARLOGIN"><font color=red>clienttoserver
CharLogin(string charname);<br></font></a> 2367 : ???????????????????????
2368 :       <br><br>
2369 :       <dl>
...
/*
2391 :   <LI><a name="CS_CHARLIST"><font color=red>clienttoserver CharList( void
);<br></font></a> 2392 :       ???????台?? 2393 :       <br><br> 2394 : <hr>
2395 :       <br>
*/
...
/*
2438 :   <LI><a name="CS_CHARLOGOUT"><font color=red>clienttoserver
CharLogout(void);<br></font></a> 2439 :       ????????????????????????? 2440
:       ????? 2441 :       <br> 2442 :       <hr> 2443 :       <br> 2444 :
*/
...
/*
2459 :   <LI><a name="CS_PROCGET"><font color=red>clienttoserver
ProcGet(void);<br></font></a> 2460 :       proc
????台?????????????????????????? 2461 :       <br> 2462 :       <hr>
2463 :       <br>
2464 :
*/
...
/*
2477 :   <LI><a name="CS_PLAYERNUMGET"><font color=red>clienttoserver
PlayerNumGet(void);<br></font></a> 2478 :       ????????????台??? 2479 :
<br> 2480 :       <hr> 2481 :       <br> 2482 :
*/
...
/*
2495 :   <LI><a name="CS_ECHO"><font color=red>clienttoserver Echo( string
test);<br></font></a> 2496 :       ????????????????????????? 2497 :
<br><br> 2498 :       <dl> 2499 :     <dt>string test 2500 :
<dd>????更???????????? 2501 :       </dl> 2502 :       <br> 2503 :       <hr>
2504 :       <br>
2505 :
*/
...
void old_lssproto_Echo_send(int fd, char *test) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(test),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
}
/*
2517 :   <LI><a name="CS_SHUTDOWN"><font color=red>clienttoserver Shutdown(
string passwd, int min);<br></font></a> 2518 :       ???????????<br><br>
2519 :       ??????????????去??????希?????????????????????希??
2520 :       ??????????denyaccept()?????????????????????
...
void old_lssproto_Shutdown_send(int fd, char *passwd, int min) {
  ...
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_string(passwd),
                      lssproto.workbufsize);
  lssproto_strcatsafe(lssproto.work, lssproto_mkstr_int(min),
                      lssproto.workbufsize);
  lssproto_Send(fd, lssproto.work);
}
...
int lssproto_ClientDispatchMessage(int fd, char *line) {
  ...
  lssproto_GetMessageInfo(&msgid, funcname, sizeof(funcname),
                          lssproto.token_list);
  /*
  209 :   <LI><a name="SC_XYD"><font color=blue>servertoclient XYD( int x, int
  y, int dir );<br></font></a> 210 : ?·卯??????????ㄅ??????????
  211 :       <br><br>
  */
  ...
  /*
  247 :   <LI><a name="SC_EV"><font color=blue>servertoclient EV(int seqno,int
  result);<br></font></a> 248 :     ???????EV?▋???刺????? 249 :
  ????????????????卷???????? 250 :     ???? 251 : 252 :       <dl> 253
  :     <dt>int seqno 254 :     <dd>??????EV?seqno?▋???? 255 :     <dt>int
  result 256 :     <dd>???0:?????自??
  1:?????????????▋??二??????????????? 257 :       </dL> 258 : <br>
  259 :       <hr>
  260 :       <br>
  */
  ...
  /*
  285 :   <LI><a name="SC_EN"><font color=blue>servertoclient EN(int result,int
  field);<br></font></a> 286 :
  ???????EN??DU?▋???刺???????????卷????????????????????? 287 : 288 :
  <dl> 289 :     <dt>int result 290 :     <dd>???0:??????自?or????
  1:???·卯???2:▋??·卯???????·卯????二    ??????????????? 291 :
  <dt>int field 292 :     <dd>????????吻?? 293 :      </dL> 294 :       <br> 295
  :       <hr> 296 :       <br> 297 :
  */
  ...
  /*
  342 :   <LI><a name="SC_RS"><font color=blue>servertoclient RS( string data
  );<br></font></a> 343 :     ·卯???台????????????二ρ?<br> 344 :
  RS|吻?(10)|?????????(10)|EXP(62),吻?|?????????|EXP,???,?????|?????|?????<br><br>
  345 :
  吻????π?5希??希????","????????╱???????????????吻??-2?<br>
  346 : 2???4????????吻??0?4)??????π????????????????????","????<br>
  347 :     ?????????〈?"|"????????????????????????"|"????
  ...
  */
  ...
  if (strcmp(funcname, "RS") == 0) {
    char *data;
    data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[1], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[2]));
    lssproto_RS_recv(fd, data);
    return 0;
  }
  /*
  349 :   <LI><a name="SC_RD"><font color=blue>servertoclient RD( string data
  );<br></font></a> 350 :     ???????台?????????????二ρ?<br> 351 :
  RD|台?(??)DP(62)|???DP(62)|<br><br> 352 : 353 :
  */
  ...
  /*
  377 :   <LI><a name="SC_B"><font color=blue>servertoclient B( string command
  );<br></font></a> 378 : ·卯???????「?????π??「? ?更?16???<BR> 379
  : ???[?吻?]????????????吻????? 380 :
  〈??????????〈???????????￥?????????? 381 :     <br><br> 382 : <h4>
  383 : ???????
  384 : </h4>
  ...
  406 :
  407 : (二???)
  B|BH|attack_0|defense_A|flag_2|damage_32|defense_B|flag_2|damage_32|FF|<BR>
  408 :
  ???0吻?(attack_0)A吻(defense_A)?0x32???????(damage_32)???B吻(defense_B)????????0x32????(damage_32)??????????<Br><Br>
  409 :
  410 : (???????)
  B|BH|attack_0|defense_A|flag_2|dagame_32|counter_0|flag_10|damage_16|FF|<BR>
  411 :
  ???0吻?(attack_0)?A吻????(defense_A)????0x32(damage_32)???????0吻(counter_0)???????(flag_10)????0x16(damage_16)?????????????????伶去???????〈?????????︻????<Br><br>
  412 :
  413 : (?????)
  B|BH|attack_0|defense_A|flag_202|dagame_32|gardian_B|FF|<BR> 414 :
  ???0吻?(attack_0)?A吻????(defense_A)????0x32(damage_32)?????????B吻????????????????????<Br><Br>
  415 : <Br>
  416 :
  417 : <li>BT|?????卦?????<br>
  418 : BT|??￥吻?|?￥吻?|???|<br>
  ...
  */
  ...
  if (strcmp(funcname, "B") == 0) {
    char *command;
    command = lssproto_wrapStringAddr(
        lssproto_stringwrapper[1], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[2]));
  ...
  /*
  722 :   <LI><a name="SC_I"><font color=blue>servertoclient I( string data
  );<br></font></a> 723 :       (item)<br> 724 :       <br> 725 : ??????S I
  ?「??????????▋?????叉???????吻??????? 726 : 佃???????????
  727 :
  728 :       <dl>
  729 :         <dt>string data
  ...
  */
  ...
  /*
  763 :   <LI><a name="SI"><font color=blue>servertoclient SI( int fromindex,
  int toindex );</font><br> 764 :       (SwapItem) 765 :
  ?????????????????MI?可???? 766 :       ??????????????二ρ?????????? 767
  :       ??????????SI????????????? 768 :
  ??阪??????(?????????阪?????)?? 769 : ???????????去?????????????二ρ?????
  770 :       ??????????????????????????????
  ...
  */
  ...
  /*
  806 :   <LI><a name="SC_MSG"><font color=blue>servertoclient MSG( int aindex ,
  string text , int color );</font></a><br> 807 :       (MeSsaGe) 808 :
  ???????????????????????????????? 809 :
  ????????二??????????????????? 810 :
  ?????????????????T??????????????? 811 :       <dl> 812 :     <dt>int aindex
  813 :     <dd>??????????????????????叻叉????
  814 :         ??????????????????
  815 :     <dt>string text
  816 :     <dd>????????????????╱???????????????mm/dd
  hh:mm|text...|graphicsno|lv|name|itemgraphicsno 817 :
  ??????????????吋至????向??????????????????????吻?? 818 :
  二????-1???????????????㎏????????mm/dd hh:mm|text|-1 819 :
  ?????????????????????吻???宇?????? 820 :
  lv?????????????????????〈??宇???????????????????? 821 :         itemgraphicsno
  ?????????????吻???宇?????? 822 :     <dt>int color 823 :     <dd>? 824 :
  <dt> 825 :       </dl> 826 :       <br> 827 :       <hr> 828 :       <br> 829
  :
  */
  ...
  if (strcmp(funcname, "MSG") == 0) {
    ...
    text = lssproto_wrapStringAddr(
        lssproto_stringwrapper[2], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[3]));
    color = lssproto_demkstr_int(lssproto.token_list[4]);
    lssproto_MSG_recv(fd, aindex, text, color);
    return 0;
  }
  /*
  851 :   <LI><a name="SC_PME"><font color=blue>servertoclient PME( int
  objindex, int graphicsno, int x, int y, int dir, int flg, int no, string cdata
  );<br></font></a> 852 :       (PetMeSsaEffect) 853 :
  ?????????????仕?牙????<br><br> 854 :       <dl> 855 :     <dt>int
  objindex 856 :     <dd>??????????吻?? 857 :     <dt>int graphicsno 858 :
  <dd>仕????????吻? 859 :     <dt>int x,y 860 :     <dd>???ㄅ????? 861
  :     <dt>int dir; 862 :     <dd>????????????? 863 :     <dt>int flg 864 :
  <dd>?????(0)??????(1)? 865 :     <dt>int no 866 :     <dd>?吻?? 867 :
  <dt>string cdata 868 :     <dd>C
  ?????向???????????????????????????????????? 869 :
  ???╱?????????????????????????????? 870 :         ????????C ??????????
  871 :       </dl>
  872 :       <br>
  ...
  */
  ...
  if (strcmp(funcname, "PME") == 0) {
    ...
    cdata = lssproto_wrapStringAddr(
        lssproto_stringwrapper[8], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[9]));
    lssproto_PME_recv(fd, objindex, graphicsno, x, y, dir, flg, no, cdata);
    return 0;
  }
  /*
  882 :   <LI><a name="SC_AB"><font color=blue>servertoclient AB( string data
  );</font></a><br> 883 :       ???????????????????????「??? 884 : <dl> 885
  :     <dt>string data 886 :
  <dd>?????牙?????╱???????????????????????〈? 887 :
  ??????????????????????????? 888 :         ????希??????? 889 :
  ??????????????? 890 :         <code>??|匠?|...</code>???????
  ...
  */
  ...
  /*
  913 :   <LI><a name="SC_ABI"><font color=blue>servertoclient ABI( int num,
  string data );</font></a><br> 914 :     AB?Μ▍吭?num
  ??希??????????吻???????向????? 915 :     data???AB?????<br> 916 :
  <br> 917 :       <br> 918 :       <hr> 919 :       <br> 920 :
  */
  ...
  /*
  1011 :     <LI><a name="S2CTK"><font color=blue>servertoclient TK( int
  index,string message ,int color);<br></font></a> 1012 :       <dl> 1013 :
  <dt>index 1014 :     <dd>????????????????-1 ?????????╱ 1015 :
  ?????????????<br> 1016 :     <dt>string 1017 :     <dd>string ????, "|"
  ?2???????????????? 1018 :         ???更?????2???????????阪?????2?? 1019 :
  ??????<a href="#escaping">?????</a>?????? 1020 :         ?????????????????????
  1021 :         <ul>
  1022 :           <li>"P" ???<br>
  1023 :           ??????????希??????????????
  1024 :           ??????????????????????
  ...
  */
  ...
  if (strcmp(funcname, "TK") == 0) {
    ...
    message = lssproto_wrapStringAddr(
        lssproto_stringwrapper[2], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[3]));
    color = lssproto_demkstr_int(lssproto.token_list[4]);
  ...
  if (strcmp(funcname, "MC") == 0) {
    ...
    data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[9], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[10]));
#ifdef __SKYISLAND
  ...
  if (strcmp(funcname, "M") == 0) {
    ...
    y2 = lssproto_demkstr_int(lssproto.token_list[6]);
    data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[6], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[7]));
    lssproto_M_recv(fd, fl, x1, y1, x2, y2, data);
    return 0;
  }
  /*
  1135 :   <LI><a name="S2CC"><font color=blue>servertoclient C( string data
  );<bR></font></a> 1136 :       (Characters) 1137 :       ??????? CA
  ????????????????????? C 1138 :       ???????????????????????? 1139 : <br><br>
  1140 :       <dl>
  1141 :     <dt>string data
  1142 :     <dd>      ??????? ???3?????????????
  ...
  1149 :
  1150 :
  <code>WHICHTYPE|CHARINDEX|X|Y|DIR|BASEIMG|LEVEL|NAMECOLOR|NAME|SELFTITLE|WALKABLE|HEIGHT|POPUPNAMECOLOR</code>
  1151 :           ???????????????????????????<br>
  1152 :
  1153 :           WHICHTYPE ????????????????????
  1154 :           ????????????????????叉???????<br>
  ...
  */
  ...
  /*
  1253 :   <LI><a name="SC_CA"><font color=blue>servertoclient CA( string data
  );<br></font></a> 1254 :       (CharacterAction) 1255 :
  ???吳?????????????┤????? 1256 :       ????????????????????? 1257 :
  ?????1????????????????????????? 1258 :       ???????<br><br> 1259 : 1260
  :       <dl> 1261 :     <dt>string data 1262 :
  <dd>CHARINDEX|X|Y|ACTION|PARAM1|PARAM2|PARAM3|PARAM4|....?? 1263 :
  ?????????????PARAM???????????? 1264 : ????????????????????X,Y??ㄅ?? 1265 :
  ???????????????ㄅ?叉??? 1266 :         ??更????????????? 1267 : <table
  border> 1268 :           <tr><td>ACTION</td><td>PARAM1</td><td>PARAM2</td>
  1269 :           <td>PARAM3</td><td>PARAM4</td></tr>
  1270 : <tr><td>Stand:0</td><td>??0~7</td><td></td><td></td><td></td></tr> 1271
  :           <tr><td>Walk:1</td><td>??0~7</td><td></td><td></td><td></td></tr>
  1272 : <tr><td>Attack:2</td><td>??0~7</td><td></td><td></td><td></td></tr>
  1273 : <tr><td>Throw:3</td><td>??0~7</td><td></td><td></td><td></td></tr> 1274
  :           <tr><td>Damage:4</td><td>??0~7</td><td></td><td></td></tr> 1275 :
  <tr><td>Dead:5</td><td>??0~7</td><td></td><td></td><td></td></tr> 1276 :
  <tr><td>UseMagic:6</td><td>??0~7</td></tr> 1277 :
  <tr><td>UseItem:7</td><td>??0~7</td></tr> 1278 :
  <tr><td>Effect:8</td><td>??0~7</td><td>?????吻?</td></tr> 1279 :
  <tr><td>Down:10 (出??)</td><td>??0~7</td></tr> 1280 :           <tr><td>Sit:11
  (??)</td><td>??0~7</td></tr> 1281 :           <tr><td>Hand:12
  (??)</td><td>??0~7</td></tr> 1282 :           <tr><td>Pleasure:13
  (??)</td><td>??0~7</td></tr> 1283 :           <tr><td>Angry:14
  (凹?)</td><td>??0~7</td></tr> 1284 :           <tr><td>Sad:15
  (听??)</td><td>??0~7</td></tr> 1285 :           <tr><td>Guard:16
  (???)</td><td>??0~7</td></tr> 1286 :           <tr><td>actionwalk:17
  (??????卷?)</td><td>??0~7</td></tr> 1287 :           <tr><td>nod:18
  (????)</td><td>??0~7</td></tr> 1288 :           <tr><td>actionstand:19
  (???????????)</td><td>??0~7</td></tr> 1289 :           <tr><td>Battle:20
  (·卯?)</td><td>??0~7</td><td>BattleNo(-1
  ??牙??</td><td>SideNo</td><td>HelpNo?????????CA牙????????????</td></tr>
  1290 :           <tr><td>Leader:21
  (?????)</td><td>??0~7</td><td>0:牙? 1:牙</td></tr> 1291 :
  <tr><td>Watch:22 (·卯?·)</td><td>??0~7</td><td>0:牙?
  1:牙</td></tr> 1292 :
  <tr><td>namecolor:23(?〈??)</td><td>??0~7</td><td>?〈?吻?</td></tr>
  ...
  */
  ...
  /*
  1305 :   <LI><a name="CD"><font color=blue>servertoclient CD( string data
  );<bR></font></a> 1306 :       (CharacterDelete) 1307 :     data
  ??????,????????????? 1308 :     佃????????? 1309 :
  ??ID???????????????????????????? 1310 :       ????? 1311 :       <br> 1312
  :       <hr> 1313 :       <br> 1314 :
  */
  ...
  /*
  1315 :   <LI><a name="R"><font color=blue>servertoclient R( string data
  );<br></font></a> 1316 :       (Radar) 1317 :
  ?????????????????????????????? 1318 : ????????????????????????????
  1319 :       ????10卷????????1希?????<br><br>
  1320 :
  1321 :       <dl>
  ...
  */
  ...
  /*
  1369 :   <LI><a name="SC_S"><font color=blue>servertoclient S( string data
  );<br></font></a> 1370 :       (Status) 1371 :       ?????????????? 1372 :
  ???? ??????更?(?更?)?? ????????????? 1373 : 1更?????????????希?????2更????????
  1374 :       ??????????????????????'|'?????????
  1375 :       2????????????????<br>
  1376 :       <br>
  ...
  1381 :         fixdex fixcharm fixluck fixfireat fixwaterat fixearthat
  fixwindat 1382 :         gold 至???? 1383 :         ??index ?〈 ??
  <br> 1384 : 1385 :         ????? '|' ???????〈????? 1386 :         <a
  href="#escaping">?????</a>????? 1387 :         ??????????二????<br>
  1388 :         ?????π??????<br>
  1389 :         kubun ???向?????〈????????
  1390 :         ?????????????????????????吻?向?????????
  ...
  1479 :         </pre>
  1480 :               <font
  size=+1>?????100?℉?????????▋????</font><br> 1481 :
  <li>????????????????????????? 1482 :
  <li>????????????????????▋?????二??<br> 1483 :               <table
  border=1> 1484 :
  <tr><td>0bit?</td><td>?????????守????????????守?????????????</td></tr>
  ...
  1624 :         fixdex fixcharm fixluck fixfireat fixwaterat fixearthat
  fixwindat 1625 :         ?〈 status<br> 1626 :
  K???0?4?叉?????????叉????? 1627 :         ?????????0??????????????????
  1628 :         ?????????1??「??????
  ...
  */
  ...
  /*
  1715 :   <LI><a name="D"><font color=blue>servertoclient D( int category , int
  dx , int dy , string data );<br></font></a> 1716 :       (Display) 1717 :
  ?????牙????<br><br> 1718 : 1719 :       <dl> 1720 :     <dt>int
  category 1721 :     <dd>??牙???? 1722 :         <table border> 1723 :
  <tr><td>π</td><td>??</td></tr> 1724 :
  <tr><td>1</td><td>希???????????data?更? 1725 : ?????π?</td></tr> 1726 :
  <tr><td>2</td><td>希?????????data?更??? 1727 : ???π</td></tr> 1728 :
  </table> 1729 :     <dt>int dx 1730 :
  <dd>?????????????▋?ㄅX??吧????????伶 1731 :
  ???ㄅ??????????π???????ㄅ???? 1732 :         丙???? 1733 : <dt>int dy
  1734 :     <dd>?▋?ㄅY
  1735 :     <dt>string data
  1736 :     <dd>牙????????category????????
  ...
  */
  ...
  if (strcmp(funcname, "D") == 0) {
    ...
    data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[4], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[5]));
    lssproto_D_recv(fd, category, dx, dy, data);
    return 0;
  }
  /*
  1760 :   <li><a name="SC_FS"><font color=blue>servertoclient FS( int
  flg);<br></font></a> 1761 :
  (FlgSet)PS????????????????希?┤??????????<br><br> 1762 :       <dl>
  1763 :         <dt>int flg
  1764 :         <dd> 0 bit  0: ??Off                  1: ??On<br>
  1765 :              ?????1 bit  0: ·卯代??off          1:
  ·卯代??On    <br> 1766 :              2 bit  0: DUEL off 1: DUEL On<br>
  1767 :              3 bit  0: ?二????????     1: ???????????????????<br>
  ...
  */
  ...
  /*
  1785 :   <li><a name="SC_HL"><font color=blue>servertoclient HL( int
  flg);<br></font></a> 1786 :
  (HeLp)HL????????????????·卯????????阪????????????<br><br> 1787 : <dl>
  1788 :         <dt>int flg
  ...
  */
  ...
  /*
  1808 :   <li><a name="SC_PR"><font color=blue>servertoclient PR( int request,
  int result);<br></font></a> 1809 :
  (PartyRequest)????????PR?????????????????????????? 1810 :
  ??????﹀???兌???????? 1811 :        <br><br> 1812 : 1813 :       <dl>
  1814 :           <dt>int request
  1815 :           <dd>0: ?? 1:向?
  1816 :         <dt>int result
  1817 :         <dd>0: ? 1: ?
  ...
  */
  ...
  /*
  1835 :   <li><a name="SC_KS"><font color=blue>servertoclient KS( int
  petarray,int result);<br></font></a> 1836 :
  ???????KS?▋??刺????????╱?????????????? 1837 :        ?????????????????????
  1838 : ???·卯???︻????????????????????????ㄅ??????︻?????????? 1839
  :        ??????????????? 1840 :        <br><br> 1841 : 1842 :       <dl> 1843
  :           <dt>int petarray 1844 :           <dd>????吻? 1845 : <dt>int
  result 1846 :           <dd>0: ?????︻?????????? 1:? 1847 :       </dl>
  1848 :       <br>
  1849 :       <br>
  1850 :       <hr>
  1851 :       <br>
  */
  ...
  /*
  1935 :   <li><a name="SC_PS"><font color=blue>servertoclient PS( int result,
  int havepetindex, int havepetskill, int toindex);<br></font></a> 1936 :
  (PetSkill use result)?????????????????PS?▋?????????? 1937 :       result
  ??????????PS?▋????????????????????? 1938 : 1939 :       <dl> 1940 :
  <dt>int result 1941 :     <dd>???0: ? 1:? 1942 :         <dt>int
  havepetindex 1943 :         <dd>?吻??????????? 1944 :         <dt>int
  havepetskill 1945 :         <dd>?吻????????? 1946 :     <dt>int toindex
  1947 :     <dd> Κ???????????????????????index????????????????
  1948 :     <pre>
  1949 :       希    = 0
  1950 :       ???  = 1 ?5
  ...
  */
  ...
  /*
  2011 :   <LI><a name="S2CSKUP"><font color=blue>servertoclient SKUP( int point
  );<br></font></a> 2012 :       (SKillUP) 2013 :
  ????????????????二ρ????????????叉??? 2014 :       <br> 2015 : <br>
  2016 :       <hr>
  2017 :       <br>
  2018 :
  */
  ...
  /*
  2047 :   <LI><a name="SC_WN"><font color=blue>servertoclient WN( int
  windowtype, int buttontype, int seqno, int objindex, string data
  );<br></font></a> 2048 :       (Window)<br> 2049 :
  ??????牙???????????????二ρ???<br> 2050 :       <br> 2051 :       <dl>
  ...
  ????????向??????? 2071 : 2072 :         }WINDOW_MESSAGETYPE; 2073 : </pre>
  2074 :
  ...
  */
  ...
  if (strcmp(funcname, "WN") == 0) {
    ...
    data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[5], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[6]));
    lssproto_WN_recv(fd, windowtype, buttontype, seqno, objindex, data);
    return 0;
  }

  if (strcmp(funcname, "EF") == 0) {
    int effect = lssproto_demkstr_int(lssproto.token_list[2]);
    int level = lssproto_demkstr_int(lssproto.token_list[3]);
    char *option = lssproto_wrapStringAddr(
        lssproto_stringwrapper[3], lssproto.workbufsize,
  ...
  if (strcmp(funcname, "SE") == 0) {
    int x = lssproto_demkstr_int(lssproto.token_list[2]);
    int y = lssproto_demkstr_int(lssproto.token_list[3]);
    int senumber = lssproto_demkstr_int(lssproto.token_list[4]);
    int sw = lssproto_demkstr_int(lssproto.token_list[5]);
    lssproto_SE_recv(fd, x, y, senumber, sw);
    return 0;
  }

  if (strcmp(funcname, "ClientLogin") == 0) {
    char *result = lssproto_wrapStringAddr(
        lssproto_stringwrapper[1], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[2]));
  ...
  if (strcmp(funcname, "CreateNewChar") == 0) {
    char *result = lssproto_wrapStringAddr(
        lssproto_stringwrapper[1], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[2]));
    char *data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[2], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[3]));
  ...
  if (strcmp(funcname, "CharDelete") == 0) {
    char *result;
    char *data;
    result = lssproto_wrapStringAddr(
        lssproto_stringwrapper[1], lssproto.workbufsize,
        lssproto_demkstr_string(lssproto.token_list[2]));
    data = lssproto_wrapStringAddr(
        lssproto_stringwrapper[2], lssproto.workbufsize,
  ...
  /*
  2506 :   <LI><a name="SC_ECHO"><font color=blue>servertoclient Echo( string
  test );<br></font></a> 2507 :       Echo?▋??刺?? 2508 :       <dl> 2509 :
  <dt>string test 2510 :     <dd>????向????更???????????? 2511 :       </dl>
  2512 :       <br>
  2513 :       <br>
  2514 :       <hr>
  2515 :       <br>
...
int lssproto_InitClient(int (*writefunc)(int, char *, int), int bufsiz,
                        int fd) {
  int i;
