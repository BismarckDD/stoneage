...
#ifdef _SKILL_SELFEXPLODE //�Ա� 
//#define ATR_SELFEXPLODE(a)    ((ATR_EQU *)a->pYobi)->petSelfExplode         //�Ա�
#endif 
/*----------  ??��?  ----------*/
#define ATT_HIT             'H'                //???
#define ATT_FIRE            'Z'                //?�d
...
#define ATT_MONSTER         'W'                //��l
#define ATT_JUJUTSU         'J'                //����
#ifdef __NEW_BATTLE_EFFECT
#define ATT_EFFECT          'j'      // ������ս����Ч
#endif
//#ifdef _BATTLESKILL                // (���ɿ�) Syu ADD ս�����ܽ���
#define ATT_PROSKILL        '+'
//#endif
...
//andy_mp
#define ATT_MPDAMAGE         'p'             // MP�˺�
#define ATT_DAMAGETOHP       'h'
#define ATT_MAGICSTATUS      'm'             // ����״̬
#ifdef _MAGIC_DEEPPOISION
#define ATT_DEEPPOISION      'd'             // �綾
#endif
#define ATT_BOOMERANG        'O'             // ?????
#define ATT_SYNCHRONOUS      'Y'           //�i???
#define ATT_MALFUNCTION      'M'                //�O�l����
#define ATT_DAMAGE           'D'                //�O�l????
#define ATT_FADE_OUT         'F'                //�N�ͧT��
#define ATT_LIFE             'L'                //��??��?��
#define ATT_IN               'I'                //��??����?
...
#define ATT_NORMAL           (1 << 1)         // ��ͨ����
#define ATT_SATISFACTORY     (1 << 2)         // ����һ��
#define ATT_GUARD            (1 << 3)         // ����
#define ATT_COUNTER          (1 << 4)         // ����
#define ATT_DODGE            (1 << 5)         // ����
#define ATT_AKO1             (1 << 6)         // ��1
#define ATT_AKO2             (1 << 7)         // ��2
#define ATT_G_CRASH          (1 << 8)         // ����ײ
#define ATT_VICARIOUS        (1 << 9)         // ��Ȯ
#define ATT_REFLEX           (1 << 10)        // ����
#define ATT_ABSORPTION       (1 << 11)        // ����
#define ATT_BALLIA           (1 << 12)        // ����
#define ATT_CRUSH            (1 << 13)        // ��ײ
#define ATT_FALL             (1 << 14)        // ����
#define ATT_TOOEH            (1 << 15)        // ����
#define ATT_ATTDOUBLE        (1 << 16)        // ����ǿ������
#ifdef _SKILL_ROAR  
#define ATT_ATTROAR          (1 << 17)        // ���(������)
#endif 
#ifdef _SKILL_SELFEXPLODE                     // �Ա�
#define ATT_ATTSELFEXPLODE   (1 << 18)        // �Ա�
#endif
#ifdef _PETSKILL_EXPLODE
#define ATT_EXPLODE          (1 << 29)        // ����(���Ա�һ��,ֻ�ǽ�ɫ������ʧ)
#endif 

#define BCF_DEFMAGICATT      (1 << 19)
#define BCF_SUPERWALL        (1 << 20)
#define BCF_MODIFY           (1 << 21)        // ����ת��


//#ifdef _BATTLESKILL                         // (���ɿ�) Syu ADD ս�����ܽ���
#define ATT_ATTPREPROSKILL      (1 << 22)     // ְҵ����
#define ATT_ATTNEXTPROSKILL     (1 << 23)     // ְҵ����
#define ATT_TRAP                (1 << 25)     // ����
#define ATT_NOMISS              (1 << 26)     // ������һ�»���
//#endif

#ifdef _EQUIT_ARRANGE
#define ATT_ARRANGE             (1 << 24)    // ����ͼ
#endif
...
#define BC_REVERSE          (1 << 10)       //�N�ͧT��
#ifdef _MAGIC_WEAKEN
#define BC_WEAKEN           (1 << 11)      //����
#endif
#ifdef _MAGIC_DEEPPOISION
#define BC_DEEPPOISON       (1 << 12)      //�綾   
#endif
#ifdef _MAGIC_BARRIER
#define BC_BARRIER          (1 << 13)      //ħ��   
#endif
#ifdef _MAGIC_NOCAST
#define BC_NOCAST           (1 << 14)      //��Ĭ   
#endif

#ifdef _SARS
#define BC_SARS             (1 << 15)       // ��ɷ����
#endif
#ifdef _PETSKILL_LER
#define BC_CHANGE           (1 << 30)       // �׶�����
#endif
#ifdef _CHAR_PROFESSION
#define BC_CRAZY            (1 << 24)
#define BC_DIZZY            (1 << 16)       // ��ѣ 
#define BC_ENTWINE          (1 << 17)       // ��������
#define BC_DRAGNET          (1 << 18)       // ���޵���
#define BC_ICECRACK         (1 << 19)       // ������    
#define BC_OBLIVION         (1 << 20)       // ����
#define BC_ICEARROW         (1 << 21)       // ����
#define BC_BLOODWORMS       (1 << 22)       // ��Ѫ��
#define BC_SIGN             (1 << 23)       // һ���Ѫ
#define BC_CRAZY            (1 << 24)      // ����
#define BC_F_ENCLOSE        (1 << 25)       // ����
#define BC_I_ENCLOSE        (1 << 26)      // ������
#define BC_T_ENCLOSE        (1 << 27)      // �׸���

#ifdef _PROFESSION_ADDSKILL
#define BC_WATER            (1 << 28)      // ˮ����
#define BC_FEAR                (1 << 29)       // �־�
//#define BC_F_I_T_ENCLOSE    (1 << 28)      // ����׸���
#endif
#ifdef _PETSKILL_LER
#define BC_CHANGE            (1<<30) // �׶�����
#endif
