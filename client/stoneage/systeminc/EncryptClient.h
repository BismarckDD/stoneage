#ifndef __ENCRYPT_CLIENT_H__
#define __ENCRYPT_CLIENT_H__

#include <stdlib.h>

template <unsigned char a1, unsigned char b1, unsigned char c1,
          unsigned char fst1, unsigned char a2, unsigned char b2,
          unsigned char c2, unsigned char fst2>
...
template <unsigned char a1, unsigned char b1, unsigned char c1,
          unsigned char fst1, unsigned char a2, unsigned char b2,
          unsigned char c2, unsigned char fst2>
inline void CEncryptClient<a1, b1, c1, fst1, a2, b2, c2, fst2>::Encrypt(
    unsigned char *bufMsg, int nLen, bool bMove /*= true*/) {
...
template <unsigned char a1, unsigned char b1, unsigned char c1,
          ...
          unsigned char c2, unsigned char fst2>
inline void
CEncryptClient<a1, b1, c1, fst1, a2, b2, c2, fst2>::ChangeCode(DWORD dwData) {
