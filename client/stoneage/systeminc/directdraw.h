...
EXTERN int displayBpp; // 当前显示器的色深
...
LPDIRECTDRAWSURFACE CreateSurface(short sizeX, short sizeY, DWORD ColorKey,
...
void DrawBitmapToSurface(LPDIRECTDRAWSURFACE lpSurface, int offsetX,
                         int offsetY, LPBITMAPINFO pInfo);
void Flip(void);
