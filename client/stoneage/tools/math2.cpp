...
constexpr int MAX_RND2_TBL = 100;

int randTbl[MAX_RND2_TBL];

/* 查表法求sin值 */
const double kSineTable[360] = {
    0.000000,  0.017452,  0.034899,  0.052336,  0.069756,  0.087156,  0.104528,
    ...
    0.358368,  0.374607,  0.390731,  0.406737,  0.422618,  0.438371,  0.453991,
    ...
    0.754710,  0.766044,  0.777146,  0.788011,  0.798635,  0.809017,  0.819152,
    ...
    0.999848,  0.999391,  0.998630,  0.997564,  0.996195,  0.994522,  0.992546,
    0.990268,  0.987688,  0.984808,  0.981627,  0.978148,  0.974370,  0.970296,
    0.965926,  0.961262,  0.956305,  0.951056,  0.945519,  0.939693,  0.933580,
    0.927184,  0.920505,  0.913545,  0.906308,  0.898794,  0.891007,  0.882948,
    0.874620,  0.866025,  0.857167,  0.848048,  0.838671,  0.829037,  0.819152,
    0.809017,  0.798635,  0.788011,  0.777146,  0.766044,  0.754710,  0.743145,
    0.731354,  0.719340,  0.707107,  0.694658,  0.681998,  0.669131,  0.656059,
    0.642788,  0.629320,  0.615661,  0.601815,  0.587785,  0.573576,  0.559193,
    0.544639,  0.529919,  0.515038,  0.500000,  0.484810,  0.469472,  0.453990,
    0.438371,  0.422618,  0.406737,  0.390731,  0.374607,  0.358368,  0.342020,
    0.325568,  0.309017,  0.292372,  0.275637,  0.258819,  0.241922,  0.224951,
    0.207912,  0.190809,  0.173648,  0.156434,  0.139173,  0.121869,  0.104528,
    0.087156,  0.069756,  0.052336,  0.034900,  0.017452,  -0.000000, -0.017452,
    -0.034900, -0.052336, -0.069757, -0.087156, -0.104528, -0.121869, -0.139173,
    -0.156434, -0.173648, -0.190809, -0.207912, -0.224951, -0.241922, -0.258819,
    -0.275637, -0.292372, -0.309017, -0.325568, -0.342020, -0.358368, -0.374606,
    -0.390731, -0.406737, -0.422618, -0.438371, -0.453991, -0.469472, -0.484810,
    -0.500000, -0.515038, -0.529919, -0.544639, -0.559193, -0.573576, -0.587785,
    -0.601815, -0.615661, -0.629320, -0.642788, -0.656059, -0.669131, -0.681998,
    -0.694658, -0.707107, -0.719340, -0.731354, -0.743145, -0.754710, -0.766045,
    -0.777146, -0.788011, -0.798635, -0.809017, -0.819152, -0.829038, -0.838671,
    -0.848048, -0.857167, -0.866025, -0.874620, -0.882948, -0.891007, -0.898794,
    -0.906308, -0.913545, -0.920505, -0.927184, -0.933581, -0.939692, -0.945519,
    -0.951056, -0.956305, -0.961262, -0.965926, -0.970296, -0.974370, -0.978148,
    -0.981627, -0.984808, -0.987688, -0.990268, -0.992546, -0.994522, -0.996195,
    -0.997564, -0.998630, -0.999391, -0.999848, -1.000000, -0.999848, -0.999391,
    -0.998630, -0.997564, -0.996195, -0.994522, -0.992546, -0.990268, -0.987688,
    -0.984808, -0.981627, -0.978148, -0.974370, -0.970296, -0.965926, -0.961262,
    -0.956305, -0.951056, -0.945519, -0.939693, -0.933580, -0.927184, -0.920505,
    -0.913545, -0.906308, -0.898794, -0.891007, -0.882948, -0.874620, -0.866025,
    -0.857167, -0.848048, -0.838671, -0.829038, -0.819152, -0.809017, -0.798635,
    -0.788011, -0.777146, -0.766044, -0.754710, -0.743145, -0.731354, -0.719340,
    -0.707107, -0.694659, -0.681998, -0.669131, -0.656059, -0.642788, -0.629321,
    -0.615661, -0.601815, -0.587785, -0.573576, -0.559193, -0.544639, -0.529919,
    -0.515038, -0.500000, -0.484809, -0.469472, -0.453991, -0.438371, -0.422618,
    -0.406736, -0.390731, -0.374607, -0.358368, -0.342020, -0.325568, -0.309017,
    -0.292372, -0.275638, -0.258819, -0.241922, -0.224951, -0.207912, -0.190809,
    -0.173648, -0.156434, -0.139173, -0.121869, -0.104528, -0.087156, -0.069757,
    -0.052336, -0.034900, -0.017452
...
double atan_table[ATAN_DIV + 1] = {
    0.000000,  0.895174,  1.789911,  2.683775,  3.576334,  4.467159,  5.355825,
    6.241914,  7.125016,  8.004729,  8.880659,  9.752425,  10.619655, 11.481991,
    12.339087, 13.190611, 14.036243, 14.875682, 15.708638, 16.534838, 17.354025,
    18.165957, 18.970408, 19.767169, 20.556045, 21.336859, 22.109448, 22.873665,
    23.629378, 24.376469, 25.114835, 25.844388, 26.565051, 27.276763, 27.979474,
    28.673147, 29.357754, 30.033280, 30.699723, 31.357085, 32.005383, 32.644640,
    33.274888, 33.896167, 34.508523, 35.112011, 35.706691, 36.292630, 36.869898,
    37.438572, 37.998732, 38.550465, 39.093859, 39.629005, 40.156000, 40.674940,
    41.185925, 41.689059, 42.184443, 42.672185, 43.152390, 43.625165, 44.090620,
    44.548862, 45.000000};

const float AdjustDir(const float angle) {
  float temp_angle = angle;
  while (temp_angle < 0.0) {
    temp_angle = temp_angle + 360.0F;
  }
...
const float SinT(const float angle) {
  float adjust_angle = AdjustDir(angle);
  return (float)kSineTable[(int)adjust_angle];
}

const float CosT(const float angle) { return SinT(angle + 90.0F); }

const float Atan(const float x, const float y) {
  int c = 0;
  float a;
  float r = 0;
  float v, w;
