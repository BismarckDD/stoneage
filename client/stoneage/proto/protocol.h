...
#endif
#ifdef _PET_ITEM
void lssproto_PetItemEquip_send(int fd, int nGx, int nGy, int nPetNo,
                                int nItemNo, int nDestNO); // 宠物装备功能
#endif
#ifdef _THEATER
void lssproto_TheaterData_recv(int fd, char *pData);
#endif
#ifdef _MOVE_SCREEN
void lssproto_MoveScreen_recv(int fd, BOOL bMoveScreenMode,
                              int iXY); // client 移动荧幕
#endif
#ifdef _GET_HOSTNAME
