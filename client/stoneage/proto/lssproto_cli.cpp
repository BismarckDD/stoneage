...
1751 :              ?????1 bit  0: ·卯代??off          1:
·卯代??On <br> 1752 :              2 bit  0: DUEL off                 1:
DUEL On<br> 1753 :              3 bit  0: ?二????????     1:
???????????????????<br> 1754 : 4 bit 0: ???OK               1: ????呀<br>
1755 :       </dl> 1756 :       <br> 1757 :       <br> 1758 :       <hr> 1759 :
<br>
*/
...
:
?????????︻???????????????????????????? 2183 : <br><br>??????<br> 2184 :
????ㄩ︻???吻??????????<br> 2185 : ????ㄩ︻?????????吻??????|??<br> 2186 : ??兝
ㄩ??ㄩ1  ??ㄩ2  ?ㄩ3 2187 : 2188 : <br><br><br>?????????<br> 2189 :
??????????(︻?吻?)????????(︻?吻?)?????????(︻?吻?)?πν<br> 2190 : 2191 : </dl>
2192 :       <br>
2193 :       <br>
2194 :       <hr>
2195 :       <br>
...
int lssproto_ClientDispatchMessage(int fd, char *line) {
  ...
  */
  ...
  <dd>?????????????▋?ㄅX??吧????????伶 1731 :
  ???ㄅ??????????π???????ㄅ???? 1732 :         丙???? 1733 : <dt>int
  dy 1734 :     <dd>?▋?ㄅY 1735 :     <dt>string data 1736 :
  <dd>牙????????category???????? 1737 :         ??更???<a
  href="#escaping">?????</a>?????? 1738 :         ????? 1739 :       </dl> 1740
  :       <br> 1741 :       <br> 1742 :       <br> 1743 :       <hr> 1744 : <br>
  */
