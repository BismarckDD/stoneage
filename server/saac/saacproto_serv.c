...
int saacproto_ServerDispatchMessage(int fd, char *encoded, char *debugfun) {
  ...
  if (strcmp(funcname, "ACCharList") == 0) {
    ...
    id = saacproto_wrapStringAddr(
        saacproto_stringwrapper[1], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[2]));
    pas = saacproto_wrapStringAddr(
        saacproto_stringwrapper[2], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[3]));
    ip = saacproto_wrapStringAddr(
        saacproto_stringwrapper[3], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[4]));
    mac = saacproto_wrapStringAddr(
  ...
  if (strcmp(funcname, "ACCharDelete") == 0) {
    ...
    id = saacproto_wrapStringAddr(
        saacproto_stringwrapper[1], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[2]));
    passwd = saacproto_wrapStringAddr(
        saacproto_stringwrapper[2], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[3]));
    charname = saacproto_wrapStringAddr(
        saacproto_stringwrapper[3], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[4]));
    option = saacproto_wrapStringAddr(
        saacproto_stringwrapper[4], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[5]));
    mesgid = saacproto_demkstr_int(saacproto.token_list[6]);
  ...
  if (strcmp(funcname, "UpdataStele") == 0) {
    ...
    int time;
    int floor;
    cdkey = saacproto_wrapStringAddr(
        saacproto_stringwrapper[1], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[2]));
    name = saacproto_wrapStringAddr(
        saacproto_stringwrapper[2], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[3]));
  ...
  if (strcmp(funcname, "ACAddFM") == 0) {
    ...
    petname = saacproto_wrapStringAddr(
        saacproto_stringwrapper[5], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[6]));
    petattr = saacproto_wrapStringAddr(
        saacproto_stringwrapper[6], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[7]));
    fmrule = saacproto_wrapStringAddr(
        saacproto_stringwrapper[7], saacproto.workbufsize,
  ...
  if (strcmp(funcname, "ACJoinFM") == 0) {
    ...
    charname = saacproto_wrapStringAddr(
        saacproto_stringwrapper[3], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[4]));
    charid = saacproto_wrapStringAddr(
        saacproto_stringwrapper[4], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[5]));
  ...
  if (strcmp(funcname, "ACShowMemberList") == 0) {
    int index;
    char *tmpbuf;
    tmpbuf = saacproto_wrapStringAddr(
        saacproto_stringwrapper[1], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[2]));
  ...
  if (strcmp(funcname, "CharadataSaveSQL") == 0) {
    ...
    charadata.CHAR_list_event_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[8], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[9]));
    charadata.CHAR_list_info4_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[9], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[10]));
    charadata.CHAR_list_attackmagic_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[10], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[11]));
    charadata.CHAR_list_info5_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[11], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[12]));
    charadata.CHAR_list_profession_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[12], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[13]));
    charadata.CHAR_list_info6_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[13], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[14]));
    charadata.CHAR_list_info_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[14], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[15]));
    charadata.CHAR_list_flg_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[15], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[16]));
    charadata.CHAR_list_skill_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[16], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[17]));
    charadata.CHAR_list_item_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[17], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[18]));
    charadata.CHAR_list_title_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[18], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[19]));
    charadata.CHAR_list_mail_String = saacproto_wrapStringAddr(
        saacproto_stringwrapper[19], saacproto.workbufsize,
        saacproto_demkstr_string(saacproto.token_list[20]));
...
void saacproto_ACCharList_send(int fd, char *result, char *output, int id) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(output),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(id),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
...
/*
214 :  <li><a name="ACCharSaveS"><font color=blue>servertoclient ACCharSave(
string result , string data,int id);<br></font></a> 215 :
ACCharSave卞覆允月忒蚕［ 216 :      <br><br> 217 :      <dl> 218 :        <dt>
string result 219 :        <dd>"successful" , "failed" 及中勿木井［ 220 : <dt>
string data 221 :        <dd>"failed"及凛反    毛憎允谛棉及苇化坌月  侬 匹丐月［
222 :        <dt> int id
...
/*
256 :  <li><a name="ACCharDeleteS"><font color=blue>servertoclient
ACCharDelete(string result, string data,int id);<br></font></a> 257 :
ACCharDelete卞覆允月忒蚕［ 258 :      <br><br> 259 :      <dl> 260 :        <dt>
string result 261 :        <dd>"successful" , "failed" 及中勿木井［ 262 : <dt>
string data 263 :        <dd>"failed"及凛反    毛憎允谛棉及苇化坌月  侬 匹丐月［
264 :        <dt> int id
...
/*
290 :  <LI>    <a name="ACLockS"><font color=blue>servertoclient ACLock( string
result, string data ,int id);<br></font></a> 291 :      ACLock卞覆允月忒蚕［ 292
:      <br><br> 293 :      <dl> 294 :        <dt>string result 295 :
<dd>"successful" , "failed" 及中勿木井［ 296 :        <dt>string data 297 :
<dd>"failed"及凛反    毛憎允谛棉及苇化坌月  侬  匹丐月［ 298 :        <dt>int id
299 :        <dd>娄醒及id及公及引引戊疋□
300 :      </dl>
301 :      <br>
302 :      <br>
...
/*
318 :  <LI><a name="ACUCheckS"><font color=blue>servertoclient ACUCheck( string
mem_id );</font></a><BR> 319 :
失市它件玄扔□田□井日必□丞扔□田□卞覆仄化｝丐月交□扒□互蜇箕夫弘奶件 320 :
仄化中月井升丹井毛民尼永弁允月［ 321 : 	 <BR><BR> 322 : 	 <dl> 323 :
<dt>string mem_id 324 : 	   <dd>譬屯月覆擂及交□扒□及gamersDream member id
325 : 	 </dl>
326 : 	 <BR><BR>
327 :
328 :
...
/*
344 :  <LI><a name="DBUpdateEntryStringS"><font color=blue>servertoclient
DBUpdateEntryString( string result, string table, string key, int msgid, int
msgid2 );</font></a><BR> 345 : 	 晓及戊穴件玉及瑛绊［撩  仄化手荚汊尕第 卅及匹
骰仄化方中冗 346 : 	 <dl> 347 : 	   <dt>string result 348 :
<dD>successful 井failed 349 : 	   <dt>string table 350 : 	   <dD> 351 :
<dt>int msgid 352 : 	   <dD> 353 : 	   <dt>int msgid2 354 : 	   <dD>
355 : 	 </dL>
356 :
*/
...
/*
369 :  <LI><a name="DBDeleteEntryStringS"><font color=blue>servertoclient
DBDeleteEntryString( string result, string table, string key , int msgid , int
msgid2 );</font></a><BR> 370 : 	   侬  巨件玄伉及绰轮及瑛绊 371 : 	 <dl>
...
/*
396 :  <Li><a name="DBGetEntryStringS"><font color=blue>servertoclient
DBGetEntryString( string result, string value, string table, string key, int
msgid, int msgid2 );</font></a><BR> 397 : 	 潸曰分仄及忒曰袄 398 :
<dl> 399 : 	   <dt>string result 400 : 	   <dd>successful / failed 401 :
<dt>string value 402 : 	   <dd>袄 403 : 	   <dt>string table 404 :
<dd> 405 : 	   <dt>string key 406 : 	   <dd> 407 : 	   <dt>int msgid
408 : 	   <dd>
409 : 	   <dt>int msgid2
410 : 	   <dd>
411 : 	 </dl>
...
/*
435 :  <LI><a name="DBUpdateEntryIntS"><font color=blue>servertoclient
DBUpdateEntryInt( string result , string table, string key, int msgid, int
msgid2 );</font></a><BR> 436 : 	 DBUpdateEntry及瑛绊［ 437 : 	 <dl> 438 :
<dt>string result 439 : 	   <dd>succesful/failed 440 : <dt>string table
441 : 	   <dd>  □皮伙  毛公及引引井尹允
442 : 	   <dt>string key
443 : 	   <dd>平□毛公及引引井尹允
...
void saacproto_S_UpdataStele_send(int fd, char *ocdkey, char *oname,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(ocdkey),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(oname),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(ncdkey),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(nname),
                       saacproto.workbufsize);
...
/*
463 :  <LI><a name="DBGetEntryRankS"><font color=blue>servertoclient
DBGetEntryRank( string result , int rank , int count, string table, string key,
int msgid, int msgid2 );</font></a><BR> 464 : 	 赐匏毛忒允［ 465 : 	 <dl>
...
void saacproto_DBGetEntryRank_send(int fd, char *result, int rank, int count,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(rank),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(count),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(table),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(key),
...
/*
494 :  <LI><a name="DBDeleteEntryIntS"><font color=blue>servertoclient
DBDeleteEntryInt( string result , string table, string key, int msgid, int
msgid2 );</font></a><BR> 495 : 	 绰轮及瑛绊 496 : 	 <dl> 497 :
<dt>string result 498 : 	   <dd>successful/failed 499 : <dt>string table
500 : 	   <dd>  □皮伙  毛公及引引井尹允
501 : 	   <dt>string key
502 : 	   <dd>平□毛公及引引井尹允
...
/*
520 :  <LI><a name="DBGetEntryIntS"><font color=blue>servertoclient
DBGetEntryInt( string result , int value , string table, string key, int msgid,
int msgid2 );</font></a><BR> 521 : 	 巨件玄伉及袄毛井尹允 522 : 	 <dl>
...
/*
552 :  <LI><a name="DBGetEntryByRankS"><font color=blue>servertoclient
DBGetEntryByRank( string result , string list , string table, int msgid, int
msgid2 );</font></a><BR> 553 : 	 DBGetEntryByRank及瑛绊［ 554 : 	 <dl>
...
561 : 		     ［<br>
562 : "1,RINGO,123465,data1|2,HOGE,4567,data2|2,FUCK,4567,data3"<BR> 563 :
仇及  分午｝2匏反2谛中月仇午卞卅月［ 564 : 	   <dt>string table 565 :
<dd>  □皮伙 566 : 	   <dt>int msgid, int msgid2 567 : 	   <dd> 568 :
</dl> 569 : 570 :
*/
...
void saacproto_DBGetEntryByRank_send(int fd, char *result, char *list,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(list),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(table),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(msgid),
...
/*
583 :  <LI><a name="DBGetEntryByCountS"><font color=blue>servertoclient
DBGetEntryByCount( string result , string list , string table, int count_start,
int msgid, int msgid2 );</font></a><BR> 584 : 	 DBGetEntryByCount 及瑛绊［ 585
: 	 <dl> 586 : 	   <dt>string result 587 : 	   <dd>SUCCESSFUL/FAILED
588 : 	   <dt>string list
...
/*
611 :  <LI><a name="Broadcast"><font color=blue>servertoclient Broadcast( string
id, string charname, string message );</font></a><BR> 612 :
Broadcast及失市它件玄扔□田□井日必□丞扔□田□尺及霜耨迕 613 : 	 <dl> 614 :
<dt>string id 615 : 	   <dd>user ID 616 : 	   <dt>string charname 617 :
<dd>character name 618 : 	   <dt>string message 619 : 	   <dd>丢永本□斥
620 : 	   <dt>int flag
...
/*
642 :  <LI><a name="Message"><font color=blue>servertoclient Message( string
id_from, string charname_from, string id_to, string charname_to, string message
, int option , int mesgid );</font></a><BR> 643 :
失市它件玄扔□田□井日必□丞扔□田□卞丢永本□斥毛霜耨允月［ 644 : 	 <dl> 645 :
<dt>string id_from 646 : 	   <dd>from ID 647 : 	   <dt>string
charname_from 648 : 	   <dd>from character name 649 : 	   <dt>string
id_to 650 : 	   <dd>to ID 651 : 	   <dt>string charname_to 652 :
<dd>to character name 653 : 	   <dt>string message 654 : <dd>丢永本□斥及 655
: 	   <dt>int option 656 : 	   <dd>左皿扑亦件(晓及楮醒毛辅寰) 657 :
<dt>int mesgid 658 : 	   <dd>丢永本□斥ID 失市它件玄扔□田□及栋  迕 659 :
</dl> 660 :
*/
...
void saacproto_ACJoinFM_send(int fd, char *result, int recv, int charfdid) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(recv),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACLeaveFM_send(int fd, char *result, int resultflag,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(resultflag),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACShowMemberList_send(int fd, char *result, int index, int num,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(num),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(acceptflag),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmjoinnum),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
#ifdef _FAMILYBADGE_
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(badge),
                       saacproto.workbufsize);
#endif
  saacproto_Send(fd, saacproto.work);
}
...
#endif
{
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(floor),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmpopular),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(joinflag),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(fmsetupflag),
                       saacproto.workbufsize);
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charindex),
                       saacproto.workbufsize);
#ifdef _PERSONAL_FAME // Arminius: 家族个人声望
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfame),
                       saacproto.workbufsize);
#endif
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
#ifdef _NEW_MANOR_LAW
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(momentum),
                       saacproto.workbufsize);
#endif
  saacproto_Send(fd, saacproto.work);
}
...
void saacproto_ACFMReadMemo_send(int fd, char *result, int index, int num,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(num),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(dataindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACSetFMPoint_send(int fd, char *result, int r, int charfdid) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(r),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charfdid),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
...
void saacproto_ACFixFMPK_send(int fd, char *result, int award, int winindex,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(result),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(award),
                       saacproto.workbufsize);
...
void saacproto_ACSendFmPk_send(int fd, int userindex, int flg) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(userindex),
                       saacproto.workbufsize);
...
void saacproto_ACKick_send(int fd, int act, char *data, int id) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(act),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(id),
...
void saacproto_SendEffect_send(int fd, char *effect) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(effect),
                       saacproto.workbufsize);
  saacproto_Send(fd, saacproto.work);
}
#endif
...
void saacproto_ACCharSavePoolItem_send(int fd, char *Acces, char *Pooldataarg,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(Acces),
                       saacproto.workbufsize);
...
void saacproto_ACCharGetPoolItem_send(int fd, char *Acces, char *Pooldataarg,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(clifdid),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(npcid),
                       saacproto.workbufsize);
...
void saacproto_ACCheckCharacterOnLine_send(int fd, int charaindex, int iOnline,
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(charaindex),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(iOnline),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(data),
                       saacproto.workbufsize);
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_int(flag),
...
void saacproto_LotterySystem_send(int fd, char *award) {
  ...
  saacproto_strcatsafe(saacproto.work, saacproto_mkstr_string(award),
                       saacproto.workbufsize);
