...
static luaL_Reg NL_RegList[] = {
    ...
    {"GetStringFromIndexWithDelim",
     NPC_Lua_NL_GetStringFromIndexWithDelim}, // 拆分字符

    {"ANSI_PlayerLoop",
     NPC_Lua_NL_ANSI_PlayerLoop}, // 遍历所有在线宠物 返回所有索引编号

    {"PetLoopGetNext",
     NPC_Lua_NL_PetLoopGetNext}, // 遍历所有在线宠物 返回所有索引编号

    {"ItemLoopGetNext",
     NPC_Lua_NL_ItemLoopGetNext}, // 遍历所有道具 返回所有索引编号

    {"PlayerLoopGetNext",
     NPC_Lua_NL_PlayerLoopGetNext}, // 遍历所有人物 返回所有索引编号
    ...
    {"RunSaFuncII",
     NPC_Lua_NL_RunSaFuncII}, // 调用一个服务端内定义好的2个INT参数的函数。

    {"RunSaFuncIII",
     NPC_Lua_NL_RunSaFuncIII}, // 调用一个服务端内定义好的3个INT参数的函数。
...

{
...

  {
    ...
    //	code_convert1("UTF-8","GBK",(char *)lua_tostring(M_Script_Lua,
    //-1),strlen(lua_tostring(M_Script_Lua, -1)),token1,1024);
...

{
  ...
  if (_InitFuncName != NULL && _InitFuncName[0] != '\0') {
    ...
    print("路径(%s)%d行代码调用函数(%s)出错。\n", debug.short_src,
          debug.currentline, _InitFuncName);
...

{
...

  {
    ...
    print("NPC_Lua_BattleEndCallBack Lua Err :%d(%s)  回调名[%s]\n", TM_Ret,
          lua_tostring(M_Script_Lua, -1), TM_Battle->EndLuaFuncName);
...

{
  ...
  lua_getglobal(M_Script_Lua,
                (const char *)TM_char->lua_charfunctable[CHAR_INITFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_WALKPREFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_WALKPOSTFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_PREOVERFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_POSTOVERFUNC].string);
...
void NPC_Lua_WatchCallBack(int _meindex, int _objindex, int _chac, int _x,
                           int _y, int _dir, int *_watchopt, int _watchoptlen)

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_WATCHFUNC].string);
...

{
  ...
  lua_getglobal(M_Script_Lua,
                (const char *)TM_char->lua_charfunctable[CHAR_LOOPFUNC].string);
...
void NPC_Lua_TalkedCallBack(int _meindex, int _tomeindex,
                            const char *_messageeraseescape, int _color,
                            int _channel)

{
  ...
  */
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_TALKEDFUNC].string);
...

{
  ...
  lua_getglobal(M_Script_Lua,
                (const char *)TM_char->lua_charfunctable[CHAR_OFFFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_LOOKEDFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_ITEMPUTFUNC].string);
...
void NPC_Lua_WindowTalkedCallBack(int _meindex, int _talkindex, int _seqno,
                                  int _select, const char *_data)

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_WINDOWTALKEDFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_char->lua_charfunctable[CHAR_BATTLEPROPERTY].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_PREOVERFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_POSTOVERFUNC].string);
...
void NPC_Lua_ItemWatchCallBack(int _meindex, int _objindex, int _chac, int _x,
                               int _y, int _dir, int *_watchopt,
                               int _watchoptlen)

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)(TM_Item->lua_charfunctable[LUAITEM_WATCHFUNC].string));
...
void NPC_Lua_ItemUseCallBack(int _playindex, int _to_charindex,
                             int _haveitem_index)

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_USEFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_ATTACHFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_DETACHFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_DROPFUNC].string);
...

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_PICKUPFUNC].string);
...
void NPC_Lua_ItemDieReLifeCallBack(int _playindex, int _item_index,
                                   int _haveitem)

{
  ...
  lua_getglobal(
      M_Script_Lua,
      (const char *)TM_Item->lua_charfunctable[LUAITEM_DIERELIFEFUNC].string);
...

{
...

  {
    ...
    snprintf(TM_MsgBuff, sizeof(TM_MsgBuff), "交出%s。",
...
int NPC_Lua_CreateVsEnemy(lua_State *_NLL, int _CharaIndex, int _NpcIndex,
                          const char *_DoFunc, PCREATEENEMY _CreateEnemy,
                          int _ARLen, int _Flg) {
...

  {
    ...
    TM_EnemyIndex =
        ENEMY_createEnemy(_CreateEnemy[i].EnemyId, _CreateEnemy[i].BaseLevel);
    ...
    if (100466 <= TM_Work && TM_Work <= 100471) {
      ...
      CHAR_setWorkInt(TM_EnemyIndex, CHAR_WORKBATTLEFLG,
                      ...
                      CHAR_getWorkInt(TM_EnemyIndex, CHAR_WORKBATTLEFLG) |
                          CHAR_BATTLEFLG_ABIO);
    }
  }
...
BATTLE_CreateVsEnemy_End:;

  {
...

    {
      ...
      if (TM_FD != -1)
        GmsvServer_EN_send(TM_FD, FALSE, TM_FieldNO);
...

    {
...

      {
...

        {
          ...
          if (TM_Type > 0) {
            ...
            GmsvServer_EN_send(TM_FD, BattleArray[TM_BattleIndex].type,
                               TM_FieldNO);
          }
        }
...

      {
        ...
        if (CHAR_getWorkInt(TM_Pindex, CHAR_WORKBATTLEMODE) ==
...
int NPC_Lua_CreateVsPlayer(int *_OutBattleIndex, int char_index0,
                           int char_index1)

{
  ...
  if (CHAR_getInt(char_index0, CHAR_FLOOR) == 8250 ||
      ...
      //		CHAR_getWorkInt( char_index0, CHAR_WORKPARTYMODE ) !=
      //CHAR_PARTY_LEADER ||
      ...
      //		CHAR_getWorkInt( char_index1, CHAR_WORKPARTYMODE ) !=
      //CHAR_PARTY_LEADER
  ...
  /*
          ...
          if( PKLIST_CheckPKReapetTeam(
                          ...
                          CHAR_getInt( char_index1, CHAR_PKLISTTEAMNUM) ) ==
     FALSE ){

                  CHAR_talkToCli( char_index0, -1, "重复战斗。",
     CHAR_COLORYELLOW );

                  CHAR_talkToCli( char_index1, -1, "重复战斗。",
     CHAR_COLORYELLOW );
