...
#define CHAR_MAXUPLEVEL 140 // 2026.08.27 SET MAXUPLEVEL=140
...
// 2026.08.28 这个地方插入了CHAR_TYPELUANPC
typedef enum {
  CHAR_INITFUNC,
  ...
  CHAR_DYINGFUNC,
  CHAR_TALKEDFUNC,
  CHAR_PREATTACKEDFUNC,   // 攻击前事件 = 9
  CHAR_POSTATTACKEDFUNC,  // 攻击后事件 = 10
  CHAR_OFFFUNC,
  CHAR_LOOKEDFUNC,
  CHAR_ITEMPUTFUNC,
...
#define CHAR_CHECKITEMINDEX(char_index, iindex)                                \
  _CHAR_CHECKITEMINDEX(__FILE__, __LINE__, char_index, iindex)
INLINE BOOL _CHAR_CHECKITEMINDEX(char *file, int line, int char_index,
                                 int iindex);
...
#define CHAR_AddPileItem(index, item_index)                                    \
  _CHAR_AddPileItem(__FILE__, __LINE__, index, item_index)
...
INLINE BOOL _CHAR_CHECK_PROFESSION_SKILLINDEX(char *file, int line,
                                              int skillindex);
#define PROFESSION_SKILL_getSkill(char_index, skillindex)                      \
  _PROFESSION_SKILL_getSkill(__FILE__, __LINE__, char_index, skillindex)
INLINE int _PROFESSION_SKILL_getSkill(char *file, int line, int char_index,
                                      int skillindex);
