...
void saacproto_ACJoinFM_send(int fd, char *fmname, int fmindex, char *charname,
                             ...
                             int charfdid);
// #else
// void saacproto_ACJoinFM_send(int fd, char *fmname, int fmindex, char
// *charname,
...
void saacproto_ACGMFixFMData_recv(int fd, char *result, char *fmindex,
                                  int charfdid);
// 删除家族後清除对战排程
