...
inline void Encode(unsigned char *output, unsigned *input, unsigned len) {
  unsigned i, j;
...
inline void Decode(unsigned *output, unsigned char *input, unsigned len) {
  unsigned i, j;
...
inline void MD5Update(MD5_CTX *context, unsigned char *input,
                      unsigned inputLen) {
