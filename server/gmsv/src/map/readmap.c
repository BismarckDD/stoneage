  ...
  for(i=0;i<Player_Diy_Map_NUM;i++){
    if(PlayerDiyMap[i].ff==ff){
      if(strcmp(CHAR_getChar(charaindex, CHAR_CDKEY), PlayerDiyMap[i].cdkey )!=0){
        CHAR_talkToCli( charaindex, -1, "�õ�ͼ��������ģ����޷��ڴ�DIY...",  CHAR_COLORRED);
      }
      if( tile != -1 ){
        MAP_map[floorindex].tile[fy*xsiz+fx] = tile;
...
BOOL MAP_SetExWarp(int mapid , int fl, int x, int y, int type)
{
  ...
  MAP_map[tomapindex].MapType = type;//��ͼ���ͣ� Ŀǰ���������� �����޸ĵ�Ȩ��
  return TRUE;
}
  ...
  if ((tomapindex = MAP_getfloorIndex(mapid)) == -1)
   ...
   int mapstartid = getCopymapstartingID();//��ø�����ͼ��ʼID
    ...
    for(i=0;i<MAP_mapnum_index;i++)//�������е�ͼ��ID
      {
        if (MAP_map[i].id == j) break;//�����ͼID�Ա�ʹ��
      }
   ...
   if (mymapid == -1) {
    ...
    for(i=0;i<MAP_mapnum_index;i++)//����һ���ռ䣬�Ƿ��б��ͷţ�����У�����Ҫ���¿��ٿռ��ˡ�
      {
...
//      print( "���·����ͼ�ڴ�ɹ���\n");
  memcpy( MAP_map , MAP_map2 ,sizeof(MAP_Map) * (MAP_mapnum-100));//����֮ǰ������
    freeMemory( MAP_map2 );
    MAP_map2 = 0;
    }
    short   *tile=0;
    ...
    tile = allocateMemory( sizeof( short ) * MAP_map[tomapindex].xsiz * MAP_map[tomapindex].ysiz );//�����ͼ�ڴ�
    if( tile == NULL ){
        print( "�޷������ڴ����ͼͼ��\n");
        return -1;
    }

    obj = allocateMemory( sizeof( short ) * MAP_map[tomapindex].xsiz * MAP_map[tomapindex].ysiz );//�����ͼ�����ڴ�
    if( obj == NULL ){
         print( "�޷������ڴ����ͼ����\n");
        freeMemory( tile );
        return -1;
    ...
    olink = allocateMemory( sizeof(MAP_Objlink*) * MAP_map[tomapindex].xsiz * MAP_map[tomapindex].ysiz );//�����ͼ�����ڴ�
    if( olink == 0 ){
        print( "�޷������ڴ����ͼ����\n");
        freeMemory( obj );
        return -1;
    ...
    MAP_map[makemapindex].startpoint = (2006<<16)+(20 << 8)+(15<<0);//Ĭ��Ϊ���ͻ����峤��
...
BOOL MAP_DelMap(int mapid )
{
  ...
  if (MAP_map[tomapindex].tile != 0) freeMemory( MAP_map[tomapindex].tile );//�ͷŵ�������
  if (MAP_map[tomapindex].obj != 0) freeMemory( MAP_map[tomapindex].obj );//�ͷŵ�������
